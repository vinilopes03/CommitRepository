...
# Commit 1: Initial setup - Import necessary libraries and define constants
import requests
...
# Commit 2: Define helper function month_range
...
# Commit 3: Define function extract_commit_pairs
...
# Commit 4: Define helper function get_repository
def get_repository(text):
    match = re.search(r"https://git\.kernel\.org[^ \n\"]+", text)
    return match.group(0) if match else ""


# Commit 5: Define function parse_cve_page
...
# Commit 6: Define function get_daily_links
...
# Commit 7: Define function save_results
