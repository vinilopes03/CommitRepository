...
# Added imports, global variables, and function definitions
import requests
...
# Commit 2: Extracting monthly links
# Added function to extract daily links for each month
...
# Commit 3: Saving results to CSV
# Added function to save parsed results to a CSV file
...
# Commit 4: Main function implementation
# Added the main function to orchestrate the parsing process
def main():
